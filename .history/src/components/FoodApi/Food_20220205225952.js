        ...
        <div className="food-modal">
          <div className="food-container">
            {detailsMeals &&
              ...
              detailsMeals.map((item, index) => (
                <>
                  <div className="food-title">kkk</div>
                  <h3>Details: </h3>
                  <div className="food-desc">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quis ad, facere repellat laudantium unde sunt quas enim quia
                    eius possimus magnam obcaecati accusantium vero, delectus
                    tenetur inventore dolore culpa animi.
                  </div>
